				...
				<div class="col-md-5 mb-4">
					<div class="card text-center">
						...
						<div class="card-body">
							...
							<p class="card-text">View and manage your seat allotment.</p>
						</div>
						<div class="card-footer">
							<a
								href="<c:url value='/seats/viewseats?employeeId=${sessionScope.employeeId}'/>"
								class="btn btn-crimson">Manage</a>
						</div>
					</div>
				</div>
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-4 mb-4">
					<div class="card text-center">
						...
						<div class="card-body">
							<h5 class="card-title">Timesheets & Attendance</h5>
							<p class="card-text">Clock-in/out, view attendance, and
								manage leaves.</p>
						</div>
						<div class="card-footer">
							<a href="<c:url value='/employee/attendance'/>"
