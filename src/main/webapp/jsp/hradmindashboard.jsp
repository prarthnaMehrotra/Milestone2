				...
				<div class="col-md-5 mb-4">
					<div class="card text-center">
						...
						<div class="card-body">
							...
							<p class="card-text">View the list of all existing employees.</p>
						</div>
						<div class="card-footer">
							<a href="<c:url value='/employee/list'/>" class="btn btn-crimson">View</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-5 mb-4">
					<div class="card text-center">
						...
						<div class="card-body">
							<h5 class="card-title">Seat Assignment</h5>
							<p class="card-text">Assign seats to the employees.</p>
						</div>
						<div class="card-footer">
							<a href="<c:url value='/seats/seatdetails'/>"
								class="btn btn-crimson">View</a>
						</div>
					</div>
				</div>
				...
				<div class="col-md-5 mb-4">
					<div class="card text-center">
						...
						<div class="card-body">
							<h5 class="card-title">Seat Change Requests</h5>
							<p class="card-text">View and Respond to seat change
								requests.</p>
						</div>
						<div class="card-footer">
							<a href="<c:url value='/seatchangerequest/seatchangerequestlist'/>"
								class="btn btn-crimson">View</a>
						</div>
					</div>
				</div>
